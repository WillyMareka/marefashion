...
<head>
    ...
    <link type="text/css" href="<?php echo base_url() .'assets/ionicons/css/ionicons.css' ?>" rel="stylesheet">
  ...
  <li>
    <div class="ui simple dropdown item">
      <i class="user icon "></i> <?php echo $username;?><i class="dropdown icon"></i>
       <div class="menu">
        <a href="<?php echo base_url(). 'products/profile' ?>" class="item"><i class="edit icon"></i> View Profile</a>
